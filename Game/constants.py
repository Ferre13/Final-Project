...
CONVEYOR_X_RIGHT = SCREEN_WIDTH - 70
CONVEYOR_X_LEFT = 70
CONVEYOR_LENGTH = CONVEYOR_X_RIGHT - CONVEYOR_X_LEFT
...
# Floors (y positions)
FLOORS_EASY = [200, 160, 120, 80, 40]
FLOORS_CRAZY = FLOORS_EASY
FLOORS_MEDIUM = [200, 175, 150, 125, 100, 75, 50]
FLOORS_EXTREME = [200, 180, 160, 140, 120, 100, 80, 60, 40]
