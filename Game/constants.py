...
PCK_LVL1 = (0, 3, 5, 11, 6, 0); PCK_LVL1_FALL = (0, 17, 4, 10, 12, 0)
PCK_LVL2 = (0, 3, 21, 11, 6, 0); PCK_LVL2_FALL = (0, 17, 20, 10, 12, 0)
PCK_LVL3 = (0, 3, 36, 11, 6, 0); PCK_LVL3_FALL = (0, 17, 36, 10, 12, 0)
PCK_LVL4 = (0, 3, 52, 11, 6, 0); PCK_LVL4_FALL = (0, 17, 52, 10, 12, 0)
PCK_LVL5 = (0, 3, 68, 11, 6, 0); PCK_LVL5_FALL = (0, 17, 68, 10, 12, 0)
PCK_LVL6 = (0, 3, 84, 11, 6, 0); PCK_LVL6_FALL = (0, 17, 84, 10, 12, 0)
PCK_LVL7 = (0, 3, 100, 11, 6, 0); PCK_LVL7_FALL = (0, 17, 100, 10, 12, 0)
PCK_LVL8 = (0, 3, 116, 11, 6, 0); PCK_LVL8_FALL = (0, 17, 116, 10, 12, 0)
PCK_LVL9 = (0, 3, 132, 11, 6, 0); PCK_LVL9_FALL = (0, 17, 132, 10, 12, 0)
PCK_LVL10 = (0, 3, 148, 11, 6, 0); PCK_LVL10_FALL = (0, 17, 148, 10, 12, 0)
...
TRUCK_EMPTY = (0, 64, 0, 32, 16, 0); TRUCK_1 = (0, 64, 16, 32, 16, 0)
TRUCK_2 = (0, 64, 32, 32, 16, 0); TRUCK_3 = (0, 64, 48, 32, 16, 0)
TRUCK_4 = (0, 64, 64, 32, 16, 0); TRUCK_5 = (0, 64, 80, 32, 16, 0)
TRUCK_6 = (0, 64, 96, 32, 16, 0); TRUCK_7 = (0, 64, 112, 32, 16, 0)
TRUCK_8 = (0, 64, 128, 32, 16, 0); TRUCK_FULL = (0, 64, 144, 32, 16, 0)
...
LEVEL_EASY = (0, 33, 160, 15, 5, 0); LEVEL_MEDIUM = (0, 32, 166, 21, 5, 0)
LEVEL_EXTREME = (0, 32, 172, 27, 5, 0); LEVEL_CRAZY = (0, 32, 178, 19, 5, 0)
NUM_1 = (1, 2, 0, 4, 7, 0); NUM_2 = (1, 10, 0, 4, 7, 0)
NUM_3 = (1, 2, 8, 4, 7, 0); NUM_4 = (1, 10, 8, 4, 7, 0)
NUM_5 = (1, 2, 16, 4, 7, 0); NUM_6 = (1, 10, 16, 4, 7, 0)
NUM_7 = (1, 2, 24, 4, 7, 0); NUM_8 = (1, 10, 24, 4, 7, 0)
NUM_9 = (1, 2, 32, 4, 7, 0); NUM_0 = (1, 10, 32, 4, 7, 0)
