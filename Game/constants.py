...
MARIO_SPRITES = [MARIO_STATIC, None, MARIO_PCK, MARIO_BOSS, MARIO_REST1, MARIO_REST2]
...
LUIGI_SPRITES = [LUIGI_STATIC, None, LUIGI_PCK, LUIGI_BOSS, LUIGI_REST1, LUIGI_REST2]
